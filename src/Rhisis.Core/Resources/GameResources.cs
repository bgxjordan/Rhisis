...
namespace Rhisis.Core.Resources
{
    internal class GameResources : IGameResources
    {
        ...
        private ConcurrentDictionary<int, QuestData> _quests;
        ...
        /// <inheritdoc />
        public IReadOnlyDictionary<int, QuestData> Quests => this.GetCacheValue(GameResourcesConstants.Quests, ref this._quests);
